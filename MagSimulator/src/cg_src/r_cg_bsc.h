...
/* Endian Mode (EMODE) */                   
#define _0000_BSC_EMODE_SAME                (0x0000U) /* Endian of area n is the same as the endian of
                                                         operating mode */
...
#define _01_BSC_ADRLE_ENABLED               (0x01U) /* Configures PA0 to PA7 as the external address bus A0 to A7 */
/* Settings for External Address Buses A16 to A23 (ADRHMS and ADRHMS2) */
#define _00_BSC_ADRHM_PC0_PC7               (0x00U) /* Set PC0 to PC7 */
#define _04_BSC_ADRHM_PC0_P7n_PC7           (0x04U) /* Set PC0, PC1, P71, P72, P74, and PC5 to PC7 */
#define _02_BSC_ADRHM_P90_P97               (0x02U) /* Set P90 to P97 */
/* D8 to D15 Output Enable (DHE) */
#define _00_BSC_DHE_DISABLED                (0x00U) /* Configures PE0 to PE7 as the I/O port pins */
#define _10_BSC_DHE_ENABLED                 (0x10U) /* Configures PE0 to PE7 as the external data bus D8 to D15 */
/* D16 to D31 Output Enable (DH32E) */
#define _00_BSC_DH32E_DISABLED              (0x00U) /* Set PG7 to PG0, and P97 to P90 as I/O port */
#define _20_BSC_DH32E_ENABLED               (0x20U) /* Set PG7 to PG0, and P97 to P90 as external data bus D31 to D16 */
...
#define _80_BSC_WR32BC32E_ENABLED           (0x80U) /* Set P13 as WR#2 or BC2#, and set P12 as WR#3 or BC3# */
/*
...
/* SDCLK Enable (SDCLKE) */                 
#define _00_BSC_SDCLKE_DISABLED             (0x00U) /* Disables SDCLK output */
#define _80_BSC_SDCLKE_ENABLED              (0x80U) /* Enables SDCLK output */

/*
    Drive Capacity Control Register (DSCR)
*/
/* Pmn Drive Capacity Control (B7 - B0) */
#define _10_P24_HIGHDRIVE_ENABLE            (0x10U) /* P24 High-drive output */
#define _20_P25_HIGHDRIVE_ENABLE            (0x20U) /* P25 High-drive output */
#define _40_P26_HIGHDRIVE_ENABLE            (0x40U) /* P26 High-drive output */
#define _80_P27_HIGHDRIVE_ENABLE            (0x80U) /* P27 High-drive output */
#define _01_P50_HIGHDRIVE_ENABLE            (0x01U) /* P50 High-drive output */
#define _02_P51_HIGHDRIVE_ENABLE            (0x02U) /* P51 High-drive output */
#define _04_P52_HIGHDRIVE_ENABLE            (0x04U) /* P52 High-drive output */
#define _08_P53_HIGHDRIVE_ENABLE            (0x08U) /* P53 High-drive output */
#define _10_P54_HIGHDRIVE_ENABLE            (0x10U) /* P54 High-drive output */
#define _20_P55_HIGHDRIVE_ENABLE            (0x20U) /* P55 High-drive output */
#define _01_P90_HIGHDRIVE_ENABLE            (0x01U) /* P90 High-drive output */
#define _02_P91_HIGHDRIVE_ENABLE            (0x02U) /* P91 High-drive output */
#define _04_P92_HIGHDRIVE_ENABLE            (0x04U) /* P92 High-drive output */
#define _08_P93_HIGHDRIVE_ENABLE            (0x08U) /* P93 High-drive output */
#define _10_P94_HIGHDRIVE_ENABLE            (0x10U) /* P94 High-drive output */
#define _20_P95_HIGHDRIVE_ENABLE            (0x20U) /* P95 High-drive output */
#define _40_P96_HIGHDRIVE_ENABLE            (0x40U) /* P96 High-drive output */
#define _80_P97_HIGHDRIVE_ENABLE            (0x80U) /* P97 High-drive output */
#define _FF_PORT9_HIGHDRIVE_ENABLE          (0xFFU) /* PORT 9 High-drive output */
#define _FF_PORTA_HIGHDRIVE_ENABLE          (0xFFU) /* PORT A High-drive output */
#define _01_PB0_HIGHDRIVE_ENABLE            (0x01U) /* PB0 High-drive output */
#define _02_PB1_HIGHDRIVE_ENABLE            (0x02U) /* PB1 High-drive output */
#define _04_PB2_HIGHDRIVE_ENABLE            (0x04U) /* PB2 High-drive output */
#define _08_PB3_HIGHDRIVE_ENABLE            (0x08U) /* PB3 High-drive output */
#define _10_PB4_HIGHDRIVE_ENABLE            (0x10U) /* PB4 High-drive output */
#define _20_PB5_HIGHDRIVE_ENABLE            (0x20U) /* PB5 High-drive output */
#define _40_PB6_HIGHDRIVE_ENABLE            (0x40U) /* PB6 High-drive output */
#define _80_PB7_HIGHDRIVE_ENABLE            (0x80U) /* PB7 High-drive output */
#define _01_PC0_HIGHDRIVE_ENABLE            (0x01U) /* PC0 High-drive output */
#define _02_PC1_HIGHDRIVE_ENABLE            (0x02U) /* PC1 High-drive output */
#define _04_PC2_HIGHDRIVE_ENABLE            (0x04U) /* PC2 High-drive output */
#define _08_PC3_HIGHDRIVE_ENABLE            (0x08U) /* PC3 High-drive output */
#define _10_PC4_HIGHDRIVE_ENABLE            (0x10U) /* PC4 High-drive output */
#define _20_PC5_HIGHDRIVE_ENABLE            (0x20U) /* PC5 High-drive output */
#define _40_PC6_HIGHDRIVE_ENABLE            (0x40U) /* PC6 High-drive output */
#define _80_PC7_HIGHDRIVE_ENABLE            (0x80U) /* PC7 High-drive output */
#define _FF_PORTD_HIGHDRIVE_ENABLE          (0xFFU) /* PORT D High-drive output */
#define _FF_PORTE_HIGHDRIVE_ENABLE          (0xFFU) /* PORT E High-drive output */
#define _FF_PORTG_HIGHDRIVE_ENABLE          (0xFFU) /* PORT G High-drive output */
